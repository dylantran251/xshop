        ...
        <div class="card shadow mb-3">
            <div class="card-header">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="">
                        <a href="{{ route('admin.management.blog-category.create') }}" class="btn bg-primary text-white"><i
                            ...
                            @foreach ($blogCategory as $category)
                                <tr>
                                    <td class="align-middle">
                                        <div class="d-flex flex-row align-items-center">
                                            <img class="rounded-circle mr-3" width="48" height="48"
                                                src="{{ $category->image != null ? asset('images/blog-category/' . $category->image) : asset('img/blog/blog-1.jpg') }}"
                                                alt="">
                                    ...
                                    <th class="text-center align-middle">
                                        <div class="">
                                            <form
                                                action="{{ route('admin.management.blog-category.destroy', $category->id) }}"
                                                method="POST">
                                                @csrf
                                                <a href="{{ route('admin.management.blog-category.edit', $category->id) }}"
