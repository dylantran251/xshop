...
@section('content')
    ...
    <section class="product-details spad pb-5">
        <div class="container">
            <div class="row">
                <div class="col-4 ">
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__pic__item">
                            <img class="w-100" class="product__details__pic__item--large" src="{{ asset('images/products/'.$subImg[0]) }}" alt="">
                        </div>
                ...
                <div class="col-8">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">Giá : {{ $priceVND }}</div>
                ...
                <div class="col-lg-12">
                    <span class="h4 text-center font-weight-bold">Mô tả</span>
